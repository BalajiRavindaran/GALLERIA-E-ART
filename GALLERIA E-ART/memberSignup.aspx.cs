    ...
    public partial class memberSignup : System.Web.UI.Page
    {
        ...
        bool checkMemberExists()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from member_profile_table where member_id='" + TextBox8.Text.Trim() + "';", con);
        ...
        void NewUserSignUp()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO member_profile_table(full_name,date_of_birth,contact_number,member_type,state,city,pincode,full_address,member_id,password,account_status) VALUES(@full_name,@date_of_birth,@contact_number,@member_type,@state,@city,@pincode,@full_address,@member_id,@password,@account_status)", con);
                ...
                cmd.Parameters.AddWithValue("@member_type", DropDownList2.SelectedItem.Value);
        ...
        void validation()
        {
            ...
            {
                Label1.Visible = true;
                Label1.Text = "Select your appropriate profile";
                Label1.ForeColor = System.Drawing.Color.Red;
            }
